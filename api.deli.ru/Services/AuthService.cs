...
namespace api.deli.ru.Services
{
	public class AuthService : IAuthService
	{
		...
		public bool ValidateAppClaims(ClaimsPrincipal claimsPrincipal, string scopes)
		{
			return true;
		}
		...
		public ClaimsIdentity GetUserIdentity(Account account)
		{
			if (account != null)
			{
				var claims = new List<Claim>
				{
					new Claim(JWTClaimTypes.AccountId, account.Id.Value),
				...
				// если пользователя не найдено
				throw new ArgumentException("Invalid user_id or password.");
		}
